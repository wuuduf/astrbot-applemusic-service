...
type ConfigSet struct {
	...
	AstrBotArtifactMaxAgeHours        int     `yaml:"astrbot-artifact-max-age-hours"`
	AstrBotArtifactMaxSizeMB          int     `yaml:"astrbot-artifact-max-size-mb"`
	AstrBotArtifactJanitorIntervalSec int     `yaml:"astrbot-artifact-janitor-interval-sec"`
	AstrBotArtifactProtectSec         int     `yaml:"astrbot-artifact-protect-sec"`
}
